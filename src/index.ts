...
import pt_aff from "file-loader!../dictionaries/pt_BR.aff";
import pt_dic from "file-loader!../dictionaries/pt_BR.dic";
...
const languages: ILanguage[] = [
  { code: "pt-br", name: "Portuguese (Brazilian)", aff: pt_aff, dic: pt_dic },
      ...
      let spellchecker_overlay = {
        ...
        token: function (stream: any, state: any) {
          if (stream.eatWhile(me.rx_word_char)) {
            ...
            if (
              !word.match(/^\d+$/) &&
              me.dictionary !== undefined &&
              !me.dictionary.check(word) &&
              !me.ignored_tokens.has(word)
            ) {
              return "spell-error";
            }
          }
...
const extension: JupyterFrontEndPlugin<void> = {
  id: "@dmenezesgabriel/jupyterlab_spellchecker:plugin",
  autoStart: true,
  requires: [
    INotebookTracker,
    ICommandPalette,
